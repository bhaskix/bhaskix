...
gantt
    ...
    RFC 0003 Storage architecture :active, r0003, 2026-08-03, 2026-08-26
    RFC 0006 Kosh — unified storage from one node to many :active, r0006, 2026-08-03, 2026-08-26
    ...
    RFC 0044 Revocation that reaches the mapping :active, r0044, 2026-08-23, 2026-08-26
    RFC 0045 One adapter per workload and the three failures... :active, r0045, 2026-08-23, 2026-08-26
    section Networking
    ...
    RFC 0037 A keyboard on real hardware :active, r0037, 2026-08-22, 2026-08-26
    RFC 0038 Vendoring the xHCI definitions :active, r0038, 2026-08-22, 2026-08-26
    ...
    RFC 0005 Linux ABI compatibility as a domain personality :active, r0005, 2026-08-03, 2026-08-26
    ...
    RFC 0031 Linux compatibility as an adapter and the... :active, r0031, 2026-08-19, 2026-08-26
    RFC 0035 A system that repairs itself — supervision... :active, r0035, 2026-08-20, 2026-08-26
    RFC 0036 A relocatable program in ring 3 — the other half... :active, r0036, 2026-08-21, 2026-08-26
    RFC 0039 Pingala — a native web server and what "secure... :active, r0039, 2026-08-22, 2026-08-26
    ...
    RFC 0007 Live patching the nucleus :active, r0007, 2026-08-04, 2026-08-26
    RFC 0026 The telemetry plane :done, r0026, 2026-08-17, 1d
    RFC 0034 The adoption case and the claims it would commit... :active, r0034, 2026-08-23, 2026-08-26
    RFC 0040 Where cryptography comes from :active, r0040, 2026-08-22, 2026-08-26
    section Kernel
    RFC 0002 Project name — Bhaskix :done, r0002, 2026-08-03, 1d
    RFC 0004 Operational technology as the first target... :active, r0004, 2026-08-03, 2026-08-26
