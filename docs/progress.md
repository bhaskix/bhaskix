...
gantt
    ...
    RFC 0003 Storage architecture :active, r0003, 2026-08-03, 2026-09-05
    RFC 0006 Kosh — unified storage from one node to many :active, r0006, 2026-08-03, 2026-09-05
    ...
    RFC 0067 more than one block per round trip :active, r0067, 2026-09-02, 2026-09-05
    RFC 0068 a disk that can hold BusyBox :active, r0068, 2026-09-04, 2026-09-05
    RFC 0069 a format that need not hold the filesystem :active, r0069, 2026-09-04, 2026-09-05
    ...
    RFC 0061 a connection nobody accepted :active, r0061, 2026-08-31, 2026-09-05
    RFC 0072 a driver for the NIC this machine has :active, r0072, 2026-09-05, 2026-09-05
    ...
    RFC 0037 A keyboard on real hardware :active, r0037, 2026-08-22, 2026-09-05
    RFC 0038 Vendoring the xHCI definitions :active, r0038, 2026-08-22, 2026-09-05
    ...
    RFC 0062 a thread may not run with a TLS base it did not... :active, r0062, 2026-09-01, 2026-09-05
    section Userspace & personality
    RFC 0005 Linux ABI compatibility as a domain personality :active, r0005, 2026-08-03, 2026-09-05
    ...
    RFC 0031 Linux compatibility as an adapter and the... :active, r0031, 2026-08-19, 2026-09-05
    RFC 0035 A system that repairs itself — supervision... :active, r0035, 2026-08-20, 2026-09-05
    RFC 0036 A relocatable program in ring 3 — the other half... :active, r0036, 2026-08-21, 2026-09-05
    RFC 0039 Pingala — a native web server and what "secure... :active, r0039, 2026-08-22, 2026-09-05
    ...
    RFC 0060 a writable path for a hosted process :active, r0060, 2026-08-31, 2026-09-05
    RFC 0063 releasing what a reused domain left behind :active, r0063, 2026-09-01, 2026-09-05
    ...
    RFC 0007 Live patching the nucleus :active, r0007, 2026-08-04, 2026-09-05
    RFC 0026 The telemetry plane :done, r0026, 2026-08-17, 1d
    RFC 0034 The adoption case and the claims it would commit... :active, r0034, 2026-08-23, 2026-09-05
    RFC 0040 Where cryptography comes from :active, r0040, 2026-08-22, 2026-09-05
    section Kernel
    RFC 0002 Project name — Bhaskix :done, r0002, 2026-08-03, 1d
    RFC 0004 Operational technology as the first target... :active, r0004, 2026-08-03, 2026-09-05
