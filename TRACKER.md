...
| Phase 2 bullets | **7 of 8 done** | §4 below; the eighth is networking, still open for IPv6 and a sockets API. This cell counted 7 bullets until the telemetry plane's row joined §4 on 2026-08-17 and was done the same day |
