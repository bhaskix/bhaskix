...
| Phase 2 bullets | **7 of 8 done** | §4 below; the eighth is networking, open for IPv6 alone since RFC 0027 delivered the sockets API on 2026-08-17. This cell counted 7 bullets until the telemetry plane's row joined §4 that same day |
