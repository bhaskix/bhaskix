...
| Phase 2 bullets | **8 of 8 done** | §4 below; the eighth — networking — closed 2026-08-18 when RFC 0029 landed IPv6, all six steps, measured beside v4 (the RFC itself awaits acceptance). This cell counted 7 bullets until the telemetry plane's row joined §4 on 2026-08-17, and said 7 of 8 until the networking bullet closed |
